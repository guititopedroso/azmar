...
function ProjectCard({ project }: { project: (typeof projects)[0] }) {
  return (
    <div className="card group flex flex-col h-full">
      {/* Cover */}
      <div className="relative w-full aspect-video rounded-xl overflow-hidden bg-linear-to-br from-[#0d2244] to-[#071428] mb-5 flex items-center justify-center">
        {project.cover_url ? (
          <img
        ...
        <div className="absolute top-3 left-3">
          <span className="badge bg-(--ocean-700) text-white text-xs">{project.categoryLabel}</span>
        </div>
        {project.featured && (
