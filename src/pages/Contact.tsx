        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14">
            ...
            <div>
              ...
              {/* Map placeholder */}
              <div className="mt-10 rounded-2xl overflow-hidden border border-[rgba(30,80,160,0.25)] h-60 bg-linear-to-br from-[#0d2244] to-[#071428] flex items-center justify-center">
      ...
      <section className="section bg-subtle">
        <div className="container text-center">
          <h2 className="text-white mb-4">
            Precisas de um orçamento{' '}
            <span className="gradient-text">detalhado?</span>
          </h2>
          <p className="text-[#94a3b8] text-lg max-w-xl mx-auto mb-8">
            Usa o nosso formulário de orçamento para nos dares mais detalhes sobre o teu projeto.
          </p>
