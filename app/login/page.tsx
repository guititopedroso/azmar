      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          <Link href="/" className="inline-flex items-center gap-3 group">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-teal-400 to-[#2563b0] flex items-center justify-center shadow-lg group-hover:shadow-teal-400/30 transition-all">
