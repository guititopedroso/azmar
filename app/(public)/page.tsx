...
export const metadata: Metadata = {
  title: 'AZMAR — Presença Digital para Negócios Locais em Setúbal',
  description:
        ...
        <div className="container relative z-10 pt-28 pb-20">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in-up delay-300">
              ...
              <Link href="/pacotes" className="btn btn-secondary btn-lg">
                Ver Pacotes
              </Link>
              ...
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {['A', 'T', 'M'].map((l) => (
                    <div
                      key={l}
                      className="w-8 h-8 rounded-full bg-gradient-to-br from-[#2563b0] to-[#2dd4bf] border-2 border-[#030d1a] flex items-center justify-center text-xs font-bold text-white"
                    >
                      {l}
                    </div>
                  ))}
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s, i) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[rgba(45,212,191,0.15)] to-[rgba(37,99,176,0.1)] border border-[rgba(45,212,191,0.15)] flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {steps.map((step, i) => (
              <div key={step.num} className="relative">
                {i < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-[calc(50%+2rem)] right-0 h-px bg-gradient-to-r from-[rgba(45,212,191,0.3)] to-transparent" />
                )}
                <div className="card text-center h-full">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#2dd4bf]/20 to-[#2563b0]/20 border border-[rgba(45,212,191,0.2)] flex items-center justify-center mx-auto mb-5">
                    <span className="font-outfit font-bold text-lg text-[#2dd4bf]">
                      {step.num}
                    </span>
                  </div>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="text-center text-[#94a3b8] text-sm mt-8">
            ...
            <Link href="/pacotes" className="text-[#2dd4bf] hover:underline">
      ...
      <section className="section relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/contactos" className="btn btn-secondary btn-lg">
              Falar connosco
            </Link>
          </div>
        </div>
