...
export const metadata: Metadata = {
  title: 'Sobre a AZMAR — Agência Digital em Setúbal',
  description:
    'Conheça a AZMAR, a agência digital de Setúbal que ajuda negócios locais a modernizar a sua presença digital.',
};
