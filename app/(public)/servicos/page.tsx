...
export const metadata: Metadata = {
  title: 'Serviços — AZMAR',
  description:
    'Websites modernos, marketing digital, branding, Google Business, manutenção digital e automações para negócios locais em Setúbal e Portugal.',
};
            ...
            {services.map((s, i) => (
              ...
              >
                <div className="flex items-start gap-5">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[rgba(45,212,191,0.12)] to-[rgba(37,99,176,0.08)] border border-[rgba(45,212,191,0.15)] flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
